...
// this import not in provided solution:
...
public class ProjectsApp {
	...
	public static void main(String[] args) 
			//throws Exception  ? not in solution
	{

		//these 2 lines not in provided solution:
...
//			return; 
//			
//			if (Objects.curProject == projectId ) {
//				curProject = null;
//				
//       this is instructor solution:
	...
	private void updateProjectDetails() {
		if (Objects.isNull(curProject)) {
			...
			Integer difficulty = getIntInput("Enter the difficulty (rate it 1-5) ["
			...
			//"reread the current project"? what does this phrase mean
	...
	private void selectProject() {
        ...
        curProject = null;
        //setting curProject to null will unselect any currently selected project. 
	...
	private int getUserSelection() {
        ...
        //the value -1 will signal the menu processing method to exit the application
	...
	private void printOperations() {
		...
		//another option is with an enhanced for loop:
