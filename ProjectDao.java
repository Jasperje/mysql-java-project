...
public class ProjectDao extends DaoBase {
	...
	//in these three fetch...etc methods, you won't need to add catch blocks to the 
	//try-with-resource statements because the caller 
	//makes the method calls within a try block. It won't hurt to catch the SQLException and 
	//turn it into an unchecked exception as you have been doing. But it won't hurt to simply 
	//declare the exception in the method signature either. It's your choice.
	...
	public boolean modifyProjectDetails(Project project) {
		...
		try(Connection conn = DbConnection.getConnection()) {
		      ...
		      try(PreparedStatement stmt = conn.prepareStatement(sql)) {
		       ...
		       // Michael says watch the videos to edit this section correctly:
		        Integer projectId = getLastInsertId(conn, PROJECT_TABLE);
		        commitTransaction(conn);
